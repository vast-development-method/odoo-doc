...
| [`acceptance-to-workflow.json`](acceptance-to-workflow.json) | Every numbered acceptance scenario with its preconditions, operation, expected outcome, asserted amounts and the documents it exercises | 1,324 |

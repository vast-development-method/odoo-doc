...
| `suggest_based_on` | text | no | `30_days` | The historic window used by the purchase suggestion feature. Accepted values: `30_days`, `actual_demand`, `one_week`, `three_months`, `one_year`, `last_year`, `last_year_m_plus_1`, `last_year_m_plus_2`, `last_year_quarter`. |

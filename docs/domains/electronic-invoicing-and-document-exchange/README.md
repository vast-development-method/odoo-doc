...
| File | Content |
|---|---|
| [README.md](README.md) | This file: the scope, the capabilities, the actors, the twenty nine owned entities with their transport and storage names, the entities extended from other domains, the cross domain dependencies, the reading order and this list. |

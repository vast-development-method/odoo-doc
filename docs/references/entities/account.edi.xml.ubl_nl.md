# SI-Universal Business Language 2.0 (NLCIUS) (`account.edi.xml.ubl_nl`)

**Transport name:** `account.edi.xml.ubl_nl`  
**Storage name:** `account_edi_xml_ubl_nl`  
...
Machine-readable definition: `../../../schemas/data/entities/account.edi.xml.ubl_nl.json`.

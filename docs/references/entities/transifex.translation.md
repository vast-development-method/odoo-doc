...
|---|---|---|---|---|---|
| `_get_transifex_projects` | preparation rule | self | `transifex` |  | get the transifex project name for each module  .tx/config files contains the project reference first section is [main], after '[odoo-16.sale]'  :rtype: dict :return: {module_name: tx_project_name} |

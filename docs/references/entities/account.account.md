...
| `spreadsheet_fetch_debit_credit` | operation | self, args_list | `spreadsheet_account` | readonly; model | Fetch data for SYSTEM.CREDIT, SYSTEM.DEBIT and SYSTEM.BALANCE formulas The input list looks like this::      [{         date_range: {             range_type: "year"             year: int         },         company_id: int         codes: str[]         include_unposted: bool     }] |
| `spreadsheet_fetch_residual_amount` | operation | self, args_list | `spreadsheet_account` | readonly; model | Fetch data for SYSTEM.RESUDUAL formulas The input list looks like this::      [{         date_range: {             range_type: "year"             year: int         },         company_id: int         codes: str[]         include_unposted: bool     }] |
| `spreadsheet_fetch_partner_balance` | operation | self, args_list | `spreadsheet_account` | model | Fetch data for SYSTEM.PARTNER.BALANCE formulas The input list looks like this::      [{         date_range: {             range_type: "year"             year: int         },         company_id: int         codes: str[]         include_unposted: bool         partner_ids: int[]     }] |
| `get_account_group` | operation | self, account_types | `spreadsheet_account` | model |  |
| `spreadsheet_fetch_balance_tag` | operation | self, args_list | `spreadsheet_account` | model | Fetch data for SYSTEM.BALANCE.TAG formulas The input list looks like this::      [{         account_tag_ids: str[]         date_range: {             range_type: "year"             year: int         },         company_id: int         include_unposted: bool     }] |

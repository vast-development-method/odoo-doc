...
| `_get_authorize_uri` | preparation rule | self, from_url, service, scope, redirect_uri | `microsoft_account` | model | This method return the url needed to allow this instance of Odoo to access to the scope of gmail specified as parameters |

...
| `_get_authorize_uri` | preparation rule | self, service, scope, redirect_uri, state, approval_prompt, access_type | `google_account` | model | This method return the url needed to allow this instance of Odoo to access to the scope of gmail specified as parameters |

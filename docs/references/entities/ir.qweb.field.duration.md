# Qweb Field Duration (`ir.qweb.field.duration`)

**Transport name:** `ir.qweb.field.duration`  
**Storage name:** `ir_qweb_field_duration`  
...
Machine-readable definition: `../../../schemas/data/entities/ir.qweb.field.duration.json`.

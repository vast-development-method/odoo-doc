...
| `auto_delete` | Auto Delete | boolean |  | default `True`; Help: This option permanently removes any track of email after it's been sent, including from the Technical menu in the Settings, in order to preserve storage space of your database. |

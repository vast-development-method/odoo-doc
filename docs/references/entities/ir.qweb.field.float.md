# Qweb Field Float (`ir.qweb.field.float`)

**Transport name:** `ir.qweb.field.float`  
**Storage name:** `ir_qweb_field_float`  
...
Machine-readable definition: `../../../schemas/data/entities/ir.qweb.field.float.json`.

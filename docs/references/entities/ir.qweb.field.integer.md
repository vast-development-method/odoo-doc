# Qweb Field Integer (`ir.qweb.field.integer`)

**Transport name:** `ir.qweb.field.integer`  
**Storage name:** `ir_qweb_field_integer`  
...
Machine-readable definition: `../../../schemas/data/entities/ir.qweb.field.integer.json`.
